...
set_sahur_alarm() {
    while true; do
        ...
        if [[ "$current_time" == "03:30" ]]; then
            ...
            play -q $HOME/JARVIS/music/sahur.mp3
...
set_buka_alarm() {
    while true; do
        ...
        if [[ "$current_time" == "17:45" ]]; then
            ...
            play -q $HOME/JARVIS/music/bukapuasa.mp3
            play -q $HOME/JARVIS/sound/alaram.mp3
            break
        fi
        sleep 60
...
shubuh() {
	...
	for ((i=1; i<=3; i++)); do
            play -q $HOME/JARVIS/sound/subuh.mp3
	done
            break
        fi
        sleep 60
...
Dzuhur() {
	...
	for ((i=1; i<=3; i++)); do
            play -q $HOME/JARVIS/sound/dzuhur.mp3
	done
            break
        fi
        sleep 60
...
ashar() {
    while true; do
        ...
        if [[ "$current_time" == "15:00" ]]; then
          ...
          for ((i=1; i<=3; i++)); do
	    play -q $HOME/JARVIS/sound/ashar.mp3
	  done
            break
        fi
        sleep 60
...
magrib() {
	...
	for ((i=1; i<=3; i++)); do
            play -q $HOME/JARVIS/sound/magrib.mp3
	done
            break
        fi
        sleep 60
...
Isyak() {
	...
	for ((i=1; i<=3; i++)); do
            play -q $HOME/JARVIS/sound/isyak.mp3
	done
            break
        fi
        sleep 60
